...
public class View {
	...
	public void printTotalBalance(Client client) {
		...
		System.out.println("Итоговый баланс по все счетам " + totalBalance);
	}
	public void printTotalPositiveBalance(Client client) {
		...
		System.out.println("Итоговый положительный баланс по все счетам " + totalBalance);
	}
	public void printTotalNegativeBalance(Client client) {
		...
		System.out.println("Итоговый отритцательный баланс по все счетам " + totalBalance);
	}
}
