...
/**
* «адача: —оставьте описание класса дл€ представлени€ времени.
* ѕредусмотрте возможности установки времени и изменени€ его отдельных полей (час, минута, секунда)
* с проверкой допустимости вводимых значений.
* ¬ случае недопустимых значений полей поле устанавливаетс€ в значение 0.
* —оздать методы изменени€ времени на заданное количество часов, минут и секунд.
*
*/
