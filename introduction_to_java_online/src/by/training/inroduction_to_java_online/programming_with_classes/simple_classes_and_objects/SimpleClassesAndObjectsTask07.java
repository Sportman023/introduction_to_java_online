...
public class SimpleClassesAndObjectsTask07 {
	...
	private class Triangle{
		...
		String result;
		double xA; //серидина стороны c (координата x)
		double yA; //серидина стороны c (координата y)
		
		double xC = b / 2.0; //серидина стороны b (координата x)
		double yC = 0; //серидина стороны b (координата y)
		
		double xO; // пересечение медиан (координата x)
		double yO; // пересечение медиан (координата y)
		xA = (x2 + x3) / 2.0;
		yA = (y2 + y3) / 2.0;
