...
public class SimpleClassesAndObjectsTask10 {
	...
	public static void main(String[] args) {
		...
		for (int i = 0; i < airlines.length; i++) {
			...
			airlines[i] = new SimpleClassesAndObjectsTask10().new Airline(destination, generateFlightNumber(),
					planeType, randomTime(), weekDay);
		}
	...
	private class Airline {
		...
		public String toString() {
			return destination + " " + flightNumber + " " + planeType + " " + depurtueTime + " " + weekDay;
		}
