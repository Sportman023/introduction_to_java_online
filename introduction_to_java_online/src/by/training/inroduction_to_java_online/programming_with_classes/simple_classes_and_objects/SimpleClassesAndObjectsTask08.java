...
public class SimpleClassesAndObjectsTask08 {
	...
	public static void main(String[] args) {
		...
		long[] accountNumbers = { 4874057655448400L, 8298569640240071L, 2957159140240071L, 2597658924716281L,
				8549861749163495L };
		...
		for (int i = 0; i < customer.length; i++) {
			...
			customer[i] = new SimpleClassesAndObjectsTask08().new Customer(surname, name, patronymic, cardNumber,
					accountNumber);
		}
		...
		for (int i = 0; i < customer.length; i++) {
			if (customer[i].getCardNumber() >= 4024_0071_2957_1591L
					&& customer[i].getCardNumber() <= 4484_0048_7405_7655L) {
				System.out.println(customer[i].toString());
			}
		}
	}
