...
/**
* «адача: —оздать класс Book, спецификаци€ которого приведена ниже.
...
public class SimpleClassesAndObjectsTask09 {
	...
	public static void main(String[] args) {
		String[] names = {"Core Java Volume I Ц Fundamentals", "Effective Java", "Java: A BeginnerТs Guide",
		...
		String[] publishingHouse = {"Prentice Hall", "Addison Wesley", "McGraw-Hill Education",
				"McGraw-Hill Education", "Shroff/OТReilly"};
		...
		System.out.println(" ниги автора Joshua Bloch");
		for (int i = 0; i < book.length; i++) {
		...
		System.out.println(" ниги издательского дома McGraw-Hill Education");
		for (int i = 0; i < book.length; i++) {
		...
		System.out.println(" ниги изданные после 2018 год");
		for (int i = 0; i < book.length; i++) {
