...
/**
 * Задание: Удалить в строке все лишние пробелы, то есть серии подряд идущих
	...
	public static void main(String[] args) {
		...
		for (int i = 0; i < byteArrOfString.length; i++) {
			...
			if ((isFirst && byteArrOfString[i] == ASCII_Code_OF_SPACE)
					...
					|| (isFirst == false && byteArrOfString[i] == ASCII_Code_OF_SPACE
							&& byteArrOfString[i - 1] == ASCII_Code_OF_SPACE)) {
				offset++;
			} else {
